...
$(document).ready(function () {
    ...
    $('.work').fadeOut();
        ...
        $('#skills1').click(function(){
            ...
            $('.skills').delay(1000).fadeIn(1000,function(){
                // === ==> SKILLS PROGRESS BAR
        ...
        $('#skills2').click(function(){
            ...
            $('.skills').delay(1000).fadeIn(2000,function(){
                // === ==> SKILLS PROGRESS BAR
